...
{
    SCPopoverContentTableViewController *vc = [[SCPopoverContentTableViewController new] initWithTableData:data forTextField:(UITextField*)textField withSize:size];
